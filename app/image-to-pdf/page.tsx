        ...
        <>
            ...
            <div className="mx-auto w-full max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
                <div className="prose prose-zinc dark:prose-invert max-w-none text-zinc-600 dark:text-zinc-400 leading-relaxed">
                    <h2 className="text-3xl font-bold text-zinc-900 dark:text-white mt-12 mb-6">Convert Images to PDF</h2>
                    <p className="text-lg mb-8">
                        Combine multiple images (JPG, PNG, WebP) into a single, organized PDF document directly in your browser. Perfect for creating digital photo albums, compiling scanned receipts, or preparing presentations without uploading your files.
                    </p>
                    ...
                    <p className="mb-4">Converting images to PDF is a simple process:</p>
