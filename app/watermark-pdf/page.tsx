...
import {
    ArrowRightAlt,
    BrandingWatermark, TextFields, Opacity
        ...
        <>
            ...
            <div className="mx-auto w-full max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
                <div className="prose prose-zinc dark:prose-invert max-w-none text-zinc-600 dark:text-zinc-400 leading-relaxed">
                    ...
                    <p className="mb-6">
                        Applying a semi-transparent text overlay (a watermark) across the pages of a PDF document. You can customize the text, font, color, opacity, and rotation to clearly indicate the document&apos;s status or ownership.
                    </p>
