        ...
        <>
            ...
            <div className="mx-auto w-full max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
                <div className="prose prose-zinc dark:prose-invert max-w-none text-zinc-600 dark:text-zinc-400 leading-relaxed">
                    <h2 className="text-3xl font-bold text-zinc-900 dark:text-white mt-12 mb-6">Compress Images Online</h2>
                    <p className="text-lg mb-8">
                        Reduce the file size of your JPG, PNG, and WebP images directly in your browser. Optimize your photos for faster web loading and easier sharing without sacrificing visual quality or uploading files to a server.
                    </p>
                    ...
                    <p className="mb-4">Compressing your images is quick and easy:</p>
                    ...
                    <h3 className="text-2xl font-semibold text-zinc-900 dark:text-white mt-10 mb-4">Faster Web Loading & SEO</h3>
                    <p className="mb-6">
                        Large, uncompressed images are the number one cause of slow-loading websites. By compressing your images before uploading them, you significantly improve your site&apos;s page speed. This not only provides a better user experience but also boosts your Core Web Vitals, which is a critical ranking factor for Google SEO.
                    </p>

                    <h3 className="text-2xl font-semibold text-zinc-900 dark:text-white mt-10 mb-4">Saving Storage Space</h3>
                    <p className="mb-6">
                        High-resolution photos from modern smartphones and cameras can easily exceed 5MB to 10MB per image. If you are archiving photos or managing a large digital library, compressing these files can free up gigabytes of valuable space on your hard drive or cloud storage without a noticeable drop in visual quality.
                    </p>

                    <h3 className="text-2xl font-semibold text-zinc-900 dark:text-white mt-10 mb-4">Easier Sharing & Email Limits</h3>
                    <p className="mb-6">
                        Most email providers impose strict attachment size limits (often 25MB). If you need to send a batch of photos, compressing them first ensures they fit within these limits, preventing frustrating bounce-backs and making the download process much faster for the recipient.
                    </p>

                    <h3 className="text-2xl font-semibold text-zinc-900 dark:text-white mt-10 mb-4">Format Differences: JPG vs. WebP</h3>
                    <p className="mb-6">
                        Our tool allows you to output compressed images in either JPG or WebP format. <strong>JPG</strong> is universally supported and ideal for general photography. <strong>WebP</strong>, developed by Google, provides superior compression (often 25-34% smaller than JPG) while maintaining the same quality, making it the absolute best choice for web development and modern browsers.
                    </p>
