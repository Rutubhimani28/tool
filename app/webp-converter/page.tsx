            ...
            <div className="mx-auto w-full max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
                <div className="prose prose-zinc dark:prose-invert max-w-none text-zinc-600 dark:text-zinc-400 leading-relaxed">
                    ...
                    <p className="text-lg mb-8">
                        <h2 className="text-3xl font-bold text-zinc-900 dark:text-white mt-12 mb-6">Convert Images to WebP Format</h2>
                        <p className="text-lg mb-8">
                            Convert JPG, PNG, or other common image formats to the modern WebP format directly in your browser. WebP offers superior compression for faster loading while preserving visual quality.
                        </p>
                    </p>
                    ...
                    <p className="mb-4">Converting to WebP format takes just a few clicks:</p>
                    ...
                    <h3 className="text-2xl font-semibold text-zinc-900 dark:text-white mt-10 mb-4">Improve Compatibility</h3>
                    <p className="mb-6">
                        It is common to download an image from the internet only to find it is in the WebP format, which many older photo editors and viewers cannot open. Converting these files to a standard JPG or PNG ensures maximum compatibility across all your devices and software.
                    </p>

                    <h3 className="text-2xl font-semibold text-zinc-900 dark:text-white mt-10 mb-4">Optimize for Web</h3>
                    <p className="mb-6">
                        If you are building a website, converting your bulky JPG and PNG photos into the WebP format can significantly reduce file sizes without sacrificing visual quality. This leads to faster page load times, better SEO rankings, and a smoother user experience.
                    </p>

                    <h3 className="text-2xl font-semibold text-zinc-900 dark:text-white mt-10 mb-4">Maintain Quality</h3>
                    <p className="mb-6">
                        Enjoy high-quality conversions whether you are compressing a large photo to WebP or extracting a WebP image to a lossless PNG. Our tool ensures that the visual integrity of your images is preserved throughout the conversion process.
                    </p>
